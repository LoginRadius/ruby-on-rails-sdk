module LoginRadius
  module AdvancedApi
	...
	def getCloudUserIdentityByPaginationId(event)
      return getRequest("identity", {:apikey=> appkey,:apisecret=>appsecret,:next=>event},"cloud");
      rescue LoginRadiusRaas::Exception => e
      false
      end
	  
	  
	def getCloudCustomObjectsByPaginationId(customObject,event)
      return getRequest("customobject", {:apikey=> appkey,:apisecret=>appsecret,:customObject=>customObject,:next=>event},"cloud");
      rescue LoginRadiusRaas::Exception => e
      false
      end
	...
	def getCloudUserIdentity(payload)
      return postRequest("identity",{:apikey=> appkey,:apisecret=>appsecret},payload,nil,"cloud");
	  rescue LoginRadiusRaas::Exception => e
      false
      end
	  
	  
	def getCloudCustomObjects(customObject,payload)
      return postRequest("customobject",{:apikey=> appkey,:apisecret=>appsecret,:customObject=>customObject},payload,nil,"cloud");
	  rescue LoginRadiusRaas::Exception => e
      false
      end
	
	
    def getCloudUserInsights(secret,payload)
      return postRequest("insights/userprofiles",{:apikey=> appkey,:apisecret=>secret},payload,nil,"cloud");
	  rescue LoginRadiusRaas::Exception => e
      false
      end
